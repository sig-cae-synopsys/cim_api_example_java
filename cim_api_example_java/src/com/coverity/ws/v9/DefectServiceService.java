 ...
 * 
 */
@WebServiceClient(name = "DefectServiceService", targetNamespace = "http://ws.coverity.com/v9", wsdlLocation = "http://localhost:8080/ws/v9/defectservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/ws/v9/defectservice?wsdl");
