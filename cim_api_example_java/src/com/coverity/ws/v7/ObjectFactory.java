 ...
 * generated in the com.coverity.ws.v7 package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCheckerSubcategoriesForProjectResponse_QNAME = new QName("http://ws.coverity.com/v7", "getCheckerSubcategoriesForProjectResponse");
    private final static QName _GetMergedDefectsForStreamsResponse_QNAME = new QName("http://ws.coverity.com/v7", "getMergedDefectsForStreamsResponse");
    private final static QName _UpdateDefectInstanceProperties_QNAME = new QName("http://ws.coverity.com/v7", "updateDefectInstanceProperties");
    private final static QName _UpdateDefectInstancePropertiesResponse_QNAME = new QName("http://ws.coverity.com/v7", "updateDefectInstancePropertiesResponse");
    private final static QName _GetComponentMetricsForProject_QNAME = new QName("http://ws.coverity.com/v7", "getComponentMetricsForProject");
    private final static QName _GetCheckerSubcategoriesForStreamsResponse_QNAME = new QName("http://ws.coverity.com/v7", "getCheckerSubcategoriesForStreamsResponse");
    private final static QName _GetFileContents_QNAME = new QName("http://ws.coverity.com/v7", "getFileContents");
    private final static QName _UpdateTriageForCIDsInTriageStore_QNAME = new QName("http://ws.coverity.com/v7", "updateTriageForCIDsInTriageStore");
    private final static QName _CoverityFault_QNAME = new QName("http://ws.coverity.com/v7", "CoverityFault");
    private final static QName _CreateMergedDefectResponse_QNAME = new QName("http://ws.coverity.com/v7", "createMergedDefectResponse");
    private final static QName _GetCheckerSubcategoriesForProject_QNAME = new QName("http://ws.coverity.com/v7", "getCheckerSubcategoriesForProject");
    private final static QName _GetMergedDefectHistoryResponse_QNAME = new QName("http://ws.coverity.com/v7", "getMergedDefectHistoryResponse");
    private final static QName _UpdateStreamDefects_QNAME = new QName("http://ws.coverity.com/v7", "updateStreamDefects");
    private final static QName _GetCIDForMergeKey_QNAME = new QName("http://ws.coverity.com/v7", "getCIDForMergeKey");
    private final static QName _GetComponentMetricsForProjectResponse_QNAME = new QName("http://ws.coverity.com/v7", "getComponentMetricsForProjectResponse");
    private final static QName _GetTrendRecordsForProjectResponse_QNAME = new QName("http://ws.coverity.com/v7", "getTrendRecordsForProjectResponse");
    private final static QName _GetStreamDefects_QNAME = new QName("http://ws.coverity.com/v7", "getStreamDefects");
    private final static QName _GetMergedDefectsForProject_QNAME = new QName("http://ws.coverity.com/v7", "getMergedDefectsForProject");
    private final static QName _GetStreamDefectsResponse_QNAME = new QName("http://ws.coverity.com/v7", "getStreamDefectsResponse");
    private final static QName _GetCIDsForProject_QNAME = new QName("http://ws.coverity.com/v7", "getCIDsForProject");
    private final static QName _UpdateStreamDefectsResponse_QNAME = new QName("http://ws.coverity.com/v7", "updateStreamDefectsResponse");
    private final static QName _GetCIDsForStreams_QNAME = new QName("http://ws.coverity.com/v7", "getCIDsForStreams");
    private final static QName _UpdateTriageForCIDsInTriageStoreResponse_QNAME = new QName("http://ws.coverity.com/v7", "updateTriageForCIDsInTriageStoreResponse");
    private final static QName _GetFileContentsResponse_QNAME = new QName("http://ws.coverity.com/v7", "getFileContentsResponse");
    private final static QName _GetCIDForDMCIDResponse_QNAME = new QName("http://ws.coverity.com/v7", "getCIDForDMCIDResponse");
    private final static QName _GetCIDsForStreamsResponse_QNAME = new QName("http://ws.coverity.com/v7", "getCIDsForStreamsResponse");
    private final static QName _GetTrendRecordsForProject_QNAME = new QName("http://ws.coverity.com/v7", "getTrendRecordsForProject");
    private final static QName _GetCIDsForProjectResponse_QNAME = new QName("http://ws.coverity.com/v7", "getCIDsForProjectResponse");
    private final static QName _GetStreamFunctionsInternalResponse_QNAME = new QName("http://ws.coverity.com/v7", "getStreamFunctionsInternalResponse");
    private final static QName _GetMergedDefectsForProjectResponse_QNAME = new QName("http://ws.coverity.com/v7", "getMergedDefectsForProjectResponse");
    private final static QName _GetStreamFunctionsInternal_QNAME = new QName("http://ws.coverity.com/v7", "getStreamFunctionsInternal");
    private final static QName _CreateMergedDefect_QNAME = new QName("http://ws.coverity.com/v7", "createMergedDefect");
    private final static QName _GetCIDForDMCID_QNAME = new QName("http://ws.coverity.com/v7", "getCIDForDMCID");
    private final static QName _GetMergedDefectsForStreams_QNAME = new QName("http://ws.coverity.com/v7", "getMergedDefectsForStreams");
    private final static QName _GetCIDForMergeKeyResponse_QNAME = new QName("http://ws.coverity.com/v7", "getCIDForMergeKeyResponse");
    private final static QName _GetCheckerSubcategoriesForStreams_QNAME = new QName("http://ws.coverity.com/v7", "getCheckerSubcategoriesForStreams");
    private final static QName _GetMergedDefectHistory_QNAME = new QName("http://ws.coverity.com/v7", "getMergedDefectHistory");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.coverity.ws.v7
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCheckerSubcategoriesForProjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getMergedDefectsForStreamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "updateDefectInstanceProperties")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "updateDefectInstancePropertiesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getComponentMetricsForProject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCheckerSubcategoriesForStreamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getFileContents")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "updateTriageForCIDsInTriageStore")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "CoverityFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "createMergedDefectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCheckerSubcategoriesForProject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getMergedDefectHistoryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "updateStreamDefects")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDForMergeKey")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getComponentMetricsForProjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getTrendRecordsForProjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getStreamDefects")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getMergedDefectsForProject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getStreamDefectsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDsForProject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "updateStreamDefectsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDsForStreams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "updateTriageForCIDsInTriageStoreResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getFileContentsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDForDMCIDResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDsForStreamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getTrendRecordsForProject")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDsForProjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getStreamFunctionsInternalResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getMergedDefectsForProjectResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getStreamFunctionsInternal")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "createMergedDefect")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDForDMCID")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getMergedDefectsForStreams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCIDForMergeKeyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getCheckerSubcategoriesForStreams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.coverity.com/v7", name = "getMergedDefectHistory")
